...
public final class NationOverlayS2CPacket {
    ...
    public NationOverlayS2CPacket(String dimId, int cMinX, int cMaxX, int cMinZ, int cMaxZ, List<Segment> segments, List<Label> labels) {
        this.dimId = dimId;
        this.cMinX = cMinX;
        this.cMaxX = cMaxX;
        this.cMinZ = cMinZ;
    ...
    public static NationOverlayS2CPacket decode(FriendlyByteBuf buf) {
        ...
        return new NationOverlayS2CPacket(dimId, cMinX, cMaxX, cMinZ, cMaxZ, segments, labels);
    }
    ...
    public static void handle(NationOverlayS2CPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            StarWorldClientNationOverlayState.setSnapshot(new StarWorldClientNationOverlayState.Snapshot(
                    msg.dimId,
                    msg.cMinX,
                    msg.cMaxX,
                    msg.cMinZ,
